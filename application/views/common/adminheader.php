...
<table width="1003" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
	  <td width="70%" align="center" bgcolor="#BFA06B" class="footer_text">
...
<ul>
   ...
   <li class='has-sub <?php echo $rooms_cls;?>'><a href="<?php echo base_url();?>admin/rooms"><span>Rooms</span></a>
      
   </li>
   <li class='has-sub <?php echo $users_cls;?>'><a href="<?php echo base_url();?>admin/users"><span>Users</span></a>
...
<ul>
   ...
   <?php
                ...
                {
              ?>
   <li class='has-sub'><a href="<?php echo base_url();?>admin/changepwd" style="color:#FFF;" ><span>Change Password</span></a>
